...
def main():
    ...
    ax.set_title("XDP — Average CPU Core Saturation vs Number of Ports\n"
                 "(mean across 24 cores, median over time, avg 3 repetitions)",
                 fontsize=12, fontweight="bold", pad=10)
    ax.set_xlabel("Number of Ports", fontsize=11)
    ax.set_ylabel("Average CPU Utilization per Core (%)", fontsize=11)
